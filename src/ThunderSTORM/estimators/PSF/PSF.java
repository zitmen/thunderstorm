                ...
                if(p1.ypos == p2.ypos) {
                    if(p1.zpos == p2.zpos) {
                        if(p1.intensity == p2.intensity) {
                            return (int) java.lang.Math.ceil(p1.background - p2.background);
                        }
                        return (int) java.lang.Math.ceil(p1.intensity - p2.intensity);
                    }
                    return (int) java.lang.Math.ceil(p1.zpos - p2.zpos);
                }
                return (int) java.lang.Math.ceil(p1.ypos - p2.ypos);
            }
            return (int) java.lang.Math.ceil(p1.xpos - p2.xpos);
        }
    }
}
