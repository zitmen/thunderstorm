...
public class AstigmaticBiplaneCalibrationEstimatorUI extends SymmetricGaussianEstimatorUI implements
	ICalibrationEstimatorUI
{
	...
	public AstigmaticBiplaneCalibrationEstimatorUI() {
		super();
	...
	public IEstimator getImplementation() {
		...
		PSFModel psf = angleWasSet ? new EllipticGaussianPSF(sigma, angle)
			: new EllipticGaussianWAnglePSF(sigma, 0);
