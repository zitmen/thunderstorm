 ...
 * must implement IModule) and their options panels. When a module is selected
 * from the combo box, its options panel gets shown underneath the combo box.
 *
 * @see IModule
 */
public class CardsPanel<T extends IModuleUI> implements ItemListener {
	...
	/**
	 * Initialize the panel. Insert names of modules into the combo box,
	 * initialize the options panels of the modules, and show the options panel of
	 ...
	 *         with title of panel, the combo box with all the modules, and the
	 *         options panels with the options of selected module on top (the
	 *         other options are hidden and they will get shown after a specific
	 *         module gets selected from the combo box)
	 */
	...
	public void itemStateChanged(ItemEvent evt) {
		...
		((CardLayout) (helpButtonsCardsPanel.getLayout())).show(helpButtonsCardsPanel, (String) evt
			.getItem());
	}
