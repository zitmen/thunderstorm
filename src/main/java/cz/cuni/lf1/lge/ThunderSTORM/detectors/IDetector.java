...
public interface IDetector extends IModule {
	 ...
	 * All detectors should support detection in ROI (Region Of Interest). If the
	 * ROI is non-rectangle shape, then mask is not null and contains an input
	 * image masked by the ROI.
	 *
