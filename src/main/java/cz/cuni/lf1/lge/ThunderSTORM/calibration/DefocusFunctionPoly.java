...
/**
 * A polynomial function y = a*(z-c)^2 + b + d*(z-c)^3 Note: to avoid problems
 * with over-fitting, the third degree of the polynomial is set to zero TODO:
 * this can be solved using regularization put on parameter `d`, but at the
 * moment I am not sure how to do it in a simple way using the Apache Commons
 * Math library
 */
public class DefocusFunctionPoly extends DefocusFunction {
	...
	public DefocusFunctionPoly(double w0, double a, double b, double c, double d,
		boolean scaledToNm)
	{
