...
class KDNode<T> {
	...
	protected static <T> KDNode ins(HPoint key, T val, KDNode<T> t, int lev, int K)
	...
	protected static <T> void nnbr(KDNode<T> kd, HPoint target, HRect hr, double max_dist_sqd,
		int lev, int K, NearestNeighborList nnl)
	{
