...
public class SubImage {
	...
	public SubImage(int sizeX, int sizeY, double[] xgrid, double[] ygrid, double[] values,
		double detectorX, double detectorY)
	{
		this(sizeX, sizeY, xgrid, ygrid, values, detectorX, detectorY,
			MoleculeDescriptor.Units.DIGITAL);
	}

	public SubImage(int sizeX, int sizeY, double[] xgrid, double[] ygrid, double[] values,
		double detectorX, double detectorY, MoleculeDescriptor.Units units)
	{
		this.size_x = sizeX;
		this.size_y = sizeY;
		this.xgrid = xgrid;
