...
import cz.cuni.lf1.lge.ThunderSTORM.calibration.ICalibrationProcess;
...
public class BiPlaneCalibrationPlugin implements PlugIn {
	...
	public void run(String arg) {
		...
		try {
			...
			List<IEstimatorUI> estimators = Arrays.asList(new IEstimatorUI[] {
				new BiplaneCalibrationEstimatorUI(), new AstigmaticBiplaneCalibrationEstimatorUI() }); // only
																																																// certain
																																																// estimators
																																																// can
																																																// be
			...
			BiplaneCalibrationDialog dialog = new BiplaneCalibrationDialog(filters, detectors, estimators,
				defocusFunctions);
			...
			final ICalibrationProcess process = CalibrationProcessFactory.create(calibrationConfig,
				selectedFilterUI, selectedDetectorUI, calibrationEstimatorUI, defocusModel, stageStep,
