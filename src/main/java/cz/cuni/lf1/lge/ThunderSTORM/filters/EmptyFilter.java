...
/**
 * No filtering. This is useful in case of detectors of estimators that work
 * better with raw images. The {@code filterImage} method returns the
 * {@code image} that it got on its input.
 */
