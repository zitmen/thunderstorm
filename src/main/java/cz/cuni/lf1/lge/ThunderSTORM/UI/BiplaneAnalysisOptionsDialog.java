...
public class BiplaneAnalysisOptionsDialog extends DialogStub implements ActionListener {
	...
	{
		super(new ParameterTracker("thunderstorm.analysis.biplane"), IJ.getInstance(),
			"Run biplane analysis");
	...
	protected void layoutComponents() {
		...
		CardsPanel<IBiplaneEstimatorUI> estimatorsPanel = new CardsPanel<IBiplaneEstimatorUI>(
			estimators, 0);
	...
	public IBiplaneEstimatorUI getActiveEstimatorUI() {
		return ModuleLoader.moduleByName(estimators, estimatorName.getValue());
	}

	public IRendererUI getActiveRendererUI() {
		return ModuleLoader.moduleByName(renderers, rendererName.getValue());
	}
