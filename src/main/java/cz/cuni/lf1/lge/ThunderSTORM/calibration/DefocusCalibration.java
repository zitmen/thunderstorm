...
public abstract class DefocusCalibration {
	...
	public DefocusCalibration(String calName, double angle,
		Homography.TransformationMatrix homography, double w01, double a1, double b1, double c1,
		double d1, double w02, double a2, double b2, double c2, double d2)
	{
		name = calName;
		this.angle = angle;
	...
	public void saveToFile(String path) throws IOException {
		...
		try {
			...
			new Yaml(new Homography.TransformationMatrix.YamlRepresenter()).dumpAll(objects.iterator(),
				fw);
