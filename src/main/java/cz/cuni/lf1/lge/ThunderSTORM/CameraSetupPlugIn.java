...
public class CameraSetupPlugIn implements PlugIn {
	...
	private static ParameterKey.Double photons2ADU = params.createDoubleField("photons2ADU", null,
		3.6);
	private static ParameterKey.Double quantumEfficiency = params.createDoubleField(
		"quantumEfficiency", DoubleValidatorFactory.rangeInclusive(0.0, 1.0), 1.0);
	private static ParameterKey.Double gain = params.createDoubleField("gainEM", null, 100,
	...
	private static ParameterKey.Double readoutNoise = params.createDoubleField("readoutNoise", null,
		0, new ParameterTracker.Condition()
		{
		...
		if (macroOptions != null) {
			...
			DialogStub dialog2 = new DialogStub(params, IJ.getInstance(), "Camera setup") {
				...
				protected void layoutComponents() {
					...
					final JCheckBox emGainCheckBox = new JCheckBox("EM gain:", !getIsEmGain()); // force
																																											// the
																																											// call
																																											// of
																																											// the
