...
public interface RenderingMethod {
	 ...
	 * @param z z coordinates of localized molecules. When null, 0 is used for all
	 *          molecules.
	 * @param dx localization XY uncertainty (not used in all implementations).
	 *          When null, default value is used.
	 * @param dz localization Z uncertainty (not used in all implementations).
	 *          When null, default value is used.
	 */
