...
public class ResultsTableWindow extends GenericTableWindow {
	...
	protected void packFrame() {
		...
		historyPane.add(operationsStackPanel, new GridBagConstraints(0, 0, 1, 1, 1, 0,
		...
		if (livePreview && !rt.isEmpty()) {
			...
			if (previewRenderer == null) {
				...
				previewRenderer = new RenderingQueue(rendererImplementation,
					new RenderingQueue.DefaultRepaintTask(rendererImplementation.getRenderedImage()), renderer
						.getRepaintFrequency());
			}
			//
