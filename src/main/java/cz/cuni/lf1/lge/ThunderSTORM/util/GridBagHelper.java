 ...
 * </pre> So the whole call of {@code panel.add} can be in a single line without
...
public class GridBagHelper {
     ...
     * @return the pre-allocated instance of {@code GridBagConstraints} class
     * filled with {@code x,y} and {@code w,h} values specifying the position,
     * width, and height of a control element in a grid.
     */
