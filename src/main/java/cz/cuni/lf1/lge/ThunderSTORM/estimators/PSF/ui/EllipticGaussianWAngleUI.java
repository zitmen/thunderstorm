...
public class EllipticGaussianWAngleUI extends IPsfUI {
	...
	private final transient ParameterKey.String CALIBRATION = parameters.createStringField(
		"calibration", StringValidatorFactory.fileExists(), Defaults.CALIBRATION);
	private final transient ParameterKey.String Z_RANGE = parameters.createStringField("z_range",
		RangeValidatorFactory.fromTo(), Defaults.Z_RANGE);
