...
public class TripleStateTableModel extends GenericTableModel {
	...
	EnumMap<StateName, GenericTableModel> savedStates = new EnumMap<StateName, GenericTableModel>(
		StateName.class);
	...
	public void copyOriginalToActual() {
		...
		savedStates.put(StateName.ACTUAL, null); // drop the reference to the state
																							// so it can be garabge collected
