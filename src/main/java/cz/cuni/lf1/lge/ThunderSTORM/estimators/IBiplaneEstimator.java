...
public interface IBiplaneEstimator extends IModule {
	 ...
	 * @param detections1 list of detections from the first plane returned by a
	 *          detector
	 * @param detections2 list of detections from the second plane returned by a
	 *          detector
	 ...
	 * @see IDetector
	 */
	public List<Molecule> estimateParameters(FloatProcessor plane1, FloatProcessor plane2,
