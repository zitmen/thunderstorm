...
public class CrossCorrelationDriftResults extends DriftResults {
	...
	public CrossCorrelationDriftResults(ImageStack correlationImages,
		PolynomialSplineFunction xFunction, PolynomialSplineFunction yFunction, double[] binCenters,
		double[] binDriftX, double[] binDriftY, double scale, int minFrame, int maxFrame,
