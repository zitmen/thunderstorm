...
/**
 * Similarly to DoG filter, this filter is a difference of two filters with
 * different kernels, in this case both are box kernels. Usualy the first one
 * has smaller kernel than the second one. This filter uses the separable kernel
 * feature.
 *
 * @see BoxFilter
 */
public final class DifferenceOfBoxFilters implements IFilter {
	 ...
	 *
	 * @param size1 size of the first box (if size is 3, then the box is 3x3
	 *          pixels)
	 * @param size2 size of the second, usualy larger, box (if size is 6, then the
	 *          box is 6x6 pixels)
	 */
