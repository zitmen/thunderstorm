...
public class IJDistribution implements PlugIn, TextListener {
	...
	public void run(String arg) {
		...
		if (count == 0) {
			IJ.error("ThunderSTORM: Distribution", "The \"" + table.getFrameTitle() +
				"\" table is empty");
			return;
		}
		// IJ.log(head);
	...
	void stats(int nc, double[] data, double[] pars) {
		...
		int i;
		double s = 0, min = Float.MAX_VALUE, max = -Float.MAX_VALUE, totl = 0, ave = 0, adev = 0, sdev =
			0, var = 0, skew = 0, kurt = 0, p;
