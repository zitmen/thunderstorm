...
public class CylindricalLensCalibrationPlugin implements PlugIn {
	...
	public void run(String arg) {
		...
		try {
			...
			List<IEstimatorUI> estimators = Arrays.asList(new IEstimatorUI[] { calibrationEstimatorUI }); // only
																																																		// one
																																																		// estimator
																																																		// can
																																																		// be
			...
			dialog = new AstigmatismCalibrationDialog(imp, filters, detectors, estimators,
				defocusFunctions);
			...
			final AstigmaticCalibrationProcess process =
				(AstigmaticCalibrationProcess) CalibrationProcessFactory.create(new CalibrationConfig(),
