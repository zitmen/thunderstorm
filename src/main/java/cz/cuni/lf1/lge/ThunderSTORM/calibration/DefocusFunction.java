...
abstract public class DefocusFunction extends IModuleUI<DefocusFunction> implements IModule {
	...
	public abstract DefocusFunction getNewInstance(double w0, double a, double b, double c, double d,
		boolean scaledToNm);

	public abstract DefocusFunction getNewInstance(double[] params, boolean scaledToNm);

	public abstract DefocusCalibration getCalibration(); // just to get an empty
																												// instance

	public abstract DefocusCalibration getCalibration(double angle,
