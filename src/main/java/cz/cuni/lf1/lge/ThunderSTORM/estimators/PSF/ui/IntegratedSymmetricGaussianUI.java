 ...
 * is that using FWMH range we simulate a linear defocus with the lower value of
 * the range being in focus; this is simply a convenient way of implementation
 * for data generator; it has no other semantical meaning
 */
public class IntegratedSymmetricGaussianUI extends IPsfUI {

	private final String name = "Integrated Gaussian";
	private final transient ParameterKey.String FWHM_RANGE = parameters.createStringField(
		"fwhm_range", RangeValidatorFactory.fromTo(), Defaults.FWHM_RANGE);
