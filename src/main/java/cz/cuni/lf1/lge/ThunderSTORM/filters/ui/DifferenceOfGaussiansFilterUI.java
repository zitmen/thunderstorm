...
public class DifferenceOfGaussiansFilterUI extends IFilterUI {
	...
	public DifferenceOfGaussiansFilterUI() {
		sigmaG1Param = parameters.createDoubleField("sigma1", DoubleValidatorFactory.positiveNonZero(),
			1);
		sigmaG2Param = parameters.createDoubleField("sigma2", DoubleValidatorFactory.positiveNonZero(),
			1.6);
	}
