...
public class DoubleDefocusCalibration<T extends DefocusCalibration> extends DefocusCalibration {
	...
	public DoubleDefocusCalibration(String calName, Homography.TransformationMatrix homography,
		T cal1, T cal2)
	{
		super(calName);
	...
	// TODO: the following is just a dummy implementation which is not applicable
	// for fitting!!!
