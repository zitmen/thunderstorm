...
public final class UI {
	...
	public static void showAnotherLocationDialog(IOException ex,
		final DefocusCalibration calibration)
	{
		final JDialog dialog = new JDialog(IJ.getInstance(), "Error");
		dialog.getContentPane().setLayout(new BorderLayout(0, 10));
		dialog.getRootPane().setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
		dialog.add(new JLabel("Could not save calibration file. " + ex.getMessage(),
