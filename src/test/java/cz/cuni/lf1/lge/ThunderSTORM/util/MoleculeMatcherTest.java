...
public class MoleculeMatcherTest {
	...
	public void testMatchMolecules() {
		...
		MoleculeDescriptor desc = new MoleculeDescriptor(new String[] { LABEL_ID, LABEL_X, LABEL_Y },
			new Units[] { Units.UNITLESS, Units.PIXEL, Units.PIXEL });
		...
		Molecule det1 = new Molecule(desc, new double[] { 1.0, 0.6171594495632347,
			0.4949343818140205 });
		Molecule det2 = new Molecule(desc, new double[] { 2.0, 0.3748525177688802,
			0.3864459210533293 });
		Molecule det3 = new Molecule(desc, new double[] { 3.0, 0.1256085534772942,
			0.5591895052957198 });
