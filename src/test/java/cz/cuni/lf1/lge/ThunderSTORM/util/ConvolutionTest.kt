...
object ConvolutionTest {
    ...
    fun testConvolve() {
        ...
        var expResult: FloatArray
        var kernel: FloatProcessor
        var result: FloatProcessor
        var image = FloatProcessor(5, 5, floatArrayOf(
            17f, 24f,  1f,  8f, 15f,
            23f,  5f,  7f, 14f, 16f,
             4f,  6f, 13f, 20f, 22f,
            10f, 12f, 19f, 21f,  3f,
            11f, 18f, 25f,  2f,  9f), null)
        
        // row vector kernel
        kernel = FloatProcessor(3, 1, floatArrayOf(0.1576f, 0.4854f, 0.4218f), null)
        result = Convolution.convolve2D(image, kernel, Padding.PADDING_ZERO)
        expResult = floatArrayOf(
        ...
        assertArrayEquals("Convolution with row vector kernel", expResult, result.pixels as FloatArray, 0.0001f)
        
        // column vector kernel
        kernel = FloatProcessor(1, 3, floatArrayOf(0.9572f, 0.4854f, 0.8003f), null)
        result = Convolution.convolve2D(image, kernel, Padding.PADDING_ZERO)
        expResult = floatArrayOf(
        ...
        assertArrayEquals("Convolution with column vector kernel", expResult, result.pixels as FloatArray, 0.0001f)
        
        // matrix kernel
        kernel = FloatProcessor(3, 3, floatArrayOf(
            0.9649f, 0.9572f, 0.1419f,
            0.1576f, 0.4854f, 0.4218f,
            0.9706f, 0.8003f, 0.9157f), null)
        result = Convolution.convolve2D(image, kernel, Padding.PADDING_ZERO)
        expResult = floatArrayOf(
        ...
        assertArrayEquals("Convolution with matrix kernel", expResult, result.pixels as FloatArray, 0.0001f)
    }
