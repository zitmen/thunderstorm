...
public class EllipticGaussianPSF extends PSFModel {
  ...
  double fi; //angle
  double sinfi,cosfi;
  private static final String[] parameterNames = {PSFInstance.X_POS, PSFInstance.Y_POS, PSFInstance.SIGMA, PSFInstance.SIGMA2, PSFInstance.INTENSITY, PSFInstance.BACKGROUND};
...
//          IJ.log("analytic jacobian: " + Arrays.deepToString(retVal));
  ...
  public double[] getInitialSimplex() {
    return new double[]{1, 1, 3000 , 0.1, 0.1, 10};
  }
