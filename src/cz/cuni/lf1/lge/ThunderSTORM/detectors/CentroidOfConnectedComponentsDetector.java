...
public final class CentroidOfConnectedComponentsDetector extends IDetectorUI implements IDetector {
     ...
     * threshold to zero, splitting close peaks by watershed and
     * finding centroids of connected components.
     *
     ...
     * <li>
     * then we think of the resulting image as an
    ...
    public Vector<Point> detectMoleculeCandidates(FloatProcessor image) throws FormulaParserException {
        ...
        threshold(thresholdedImage, thresholdValue, 0.0f, 255.0f);
        ...
        for(Graph.ConnectedComponent c : Graph.getConnectedComponents((ImageProcessor) thresholdImageANDWatershedImage, Graph.CONNECTIVITY_8)) {
