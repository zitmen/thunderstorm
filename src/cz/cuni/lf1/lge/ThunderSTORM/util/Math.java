...
public class Math {
   ...
   * @param sigma {
   * @mathjax \sigma} is a width of the Gaussian function
   * @param normalized decides wheter the Gaussian should be normalized to have
   * its integral equal to 1
   ...
   * value to highest value and picking the middle one (eg, the median of {3, 5,
   * 9} is 5). If there is an even number of observations, then there is no
