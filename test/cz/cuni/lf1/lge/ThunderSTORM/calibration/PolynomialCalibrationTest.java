...
public class PolynomialCalibrationTest {
    ...
    public void testSerialization() {
        double angle = 45;
        double[] sigma1 = {-10, 0.0003, 1.986, 1};
        double[] sigma2 = {2.2354, 0.0003, 2.015, 1};
        PolynomialCalibration calibration = new PolynomialCalibration(angle, new DefocusFunction(sigma1), new DefocusFunction(sigma2));
        Yaml yaml = new Yaml();
        ...
        assertEquals(sigma1[3], calibration.getD1(), 0.0001);
    }
