...
public class IterativeQuadraticFittingTest {
  ...
  public void testFitParamsAndShift() {
    ...
    double[] sigma1params = quadraticFitter.fitParams(zpos, sigma1);
    System.out.println("s1: " + Arrays.toString(sigma1params));
    double[] sigma2params = quadraticFitter.fitParams(zpos, sigma2);
    System.out.println("s2: " + Arrays.toString(sigma2params));
    ...
    assertArrayEquals(expectedS1, sigma1params, 0.001);
    assertArrayEquals(expectedS2, sigma2params, 0.001);
    IterativeQuadraticFitting.shiftToOrigin(sigma1params, sigma2params);
    assertEquals(expectedS1[0] - expectedShift, sigma1params[0], 0.001);
    assertEquals(expectedS2[0] - expectedShift, sigma2params[0], 0.001);
  }
  ...
  public void testShiftSame() {
    ...
    IterativeQuadraticFitting.shiftToOrigin(s1, s2);
    assertFalse(Double.isNaN(s1[0]));
